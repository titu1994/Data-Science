...
if __name__ == "__main__":
    ...
    logistic = linear.LogisticRegression(penalty="l1", tol=1e-7, C=10)
    ...
    for i, (x_i, y_i) in enumerate(zip(x_test, y_test)):
        ...
        if y_i == 1 and predict[i] >= 0.5:  # TP: paid and we predict paid
            true_positives += 1
        elif y_i == 1:                   # FN: paid and we predict unpaid
            false_negatives += 1
        elif predict[i] >= 0.5:             # FP: unpaid and we predict paid
            false_positives += 1
